...
class Model {
    ...
    static get tableName() {
        var _a;
        return (_a = this._tableName) !== null && _a !== void 0 ? _a : (0, pluralize_1.default)(this.name);
    }
    ...
    static initCheck() {
        (0, node_assert_1.default)(this._nessie && this._attributes, new ModelError_1.ModelInitError(`Model not initialized: ${this.name}`));
    ...
    static sync(force = false) {
        return __awaiter(this, void 0, void 0, function* () {
            this.initCheck();
            if (force) {
                yield this._nessie.execute(`BEGIN EXECUTE IMMEDIATE 'DROP TABLE "${this.tableName}"'; EXCEPTION WHEN OTHERS THEN IF sqlcode <> -942 THEN raise; END IF; END;`);
            }
    ...
    static formatAttributeKeys(attributes) {
        return Object
            ...
            if (upper in this._attributes || upper in Constants_1.Pseudocolumns) {
    ...
    static create(values, options = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { lastRowid } = yield this._nessie.execute(`INSERT INTO "${this.tableName}" (${attributeSql}) VALUES (${valuesSql})`, bindParams);
            yield this._nessie.commit();
    ...
    static bulkCreate(values, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { rowsAffected } = yield this._nessie.executeMany(sql, bindParams);
            yield this._nessie.commit();
    ...
    static parseSelectAttributeSql(attributes = Object.keys(this._attributes)) {
        return attributes
            ...
            if ((upper in this._attributes || upper in Constants_1.Pseudocolumns) && !data.includes(sql)) {
                data.push(sql);
            }
            return data;
    ...
    static update(values, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [where] = this.parseEql(options.where, bindParams);
            const { rowsAffected } = yield this._nessie.execute(`UPDATE "${this.tableName}" SET ${valuesSql} WHERE ${where}`, bindParams);
            yield this._nessie.commit();
            return rowsAffected;
        });
    }
    ...
    static destroy(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { rowsAffected } = yield this._nessie.execute(`DELETE FROM "${this.tableName}" WHERE ${where}`, bindParams);
            this._nessie.commit();
            return rowsAffected;
        });
    }
